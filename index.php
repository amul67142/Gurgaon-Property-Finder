...
<section class="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden border-y border-slate-700/50">
    <!-- Background Pattern -->
    <div class="absolute inset-0 opacity-5">
        <div class="absolute inset-0" style="background-image: radial-gradient(circle at 2px 2px, gold 1px, transparent 0); background-size: 40px 40px;"></div>
    </div>
    ...
    <!-- Glow Effect -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-secondary/10 rounded-full blur-3xl"></div>
    
    <div class="container mx-auto px-6 relative z-10">
        <!-- Section Header -->
        <div class="text-center max-w-3xl mx-auto mb-12" data-aos="fade-up">
            <div class="inline-flex items-center gap-2 bg-gradient-to-r from-secondary to-yellow-500 text-white px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider mb-4 animate-pulse">
                <i class="fa-solid fa-gift"></i> Launch Special
            </div>
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-4 font-display">
                100% Free During Launch
            </h2>
            <p class="text-xl text-slate-300">
                All membership plans absolutely free. No credit card required!
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
            <!-- Silver Plan -->
            <div class="bg-white/95 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300" data-aos="fade-up" data-aos-delay="0">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-xl font-bold text-slate-900">Silver</h3>
                        <p class="text-xs text-slate-500">For Newcomers</p>
                    </div>
                    <div class="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center">
                        <i class="fa-solid fa-medal text-slate-600 text-xl"></i>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <span class="text-slate-400 line-through text-sm">₹6,000</span>
                        <span class="bg-red-100 text-red-700 px-2 py-0.5 rounded-full text-[10px] font-bold">SAVE 100%</span>
                    </div>
                </div>
                
                <ul class="space-y-2 mb-6 text-sm text-slate-700">
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-green-500 text-xs"></i> 10 Property Listings
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-green-500 text-xs"></i> 2 Featured Slots
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-green-500 text-xs"></i> 90-Day Validity
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-green-500 text-xs"></i> Basic Analytics
                    </li>
                </ul>
                
                <a href="register.php?plan=silver" class="block w-full text-center bg-slate-900 text-white py-2.5 rounded-lg font-bold hover:bg-slate-800 transition text-xs uppercase tracking-wide">
                    Get Started Free
                </a>
            </div>

            <!-- Gold Plan (Popular) -->
            <div class="bg-gradient-to-br from-secondary/20 to-yellow-500/20 backdrop-blur-sm rounded-xl p-6 border-2 border-secondary shadow-2xl hover:shadow-secondary/30 hover:-translate-y-2 transition-all duration-300 relative scale-105" data-aos="fade-up" data-aos-delay="100">
                <div class="absolute -top-3 left-1/2 -translate-x-1/2">
                    <div class="bg-gradient-to-r from-secondary to-yellow-500 text-white px-4 py-1 rounded-full text-[10px] font-bold uppercase shadow-lg">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-xl font-bold text-slate-900">Gold</h3>
                        <p class="text-xs text-slate-600">For Professionals</p>
                    </div>
                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-secondary to-yellow-500 flex items-center justify-center shadow-lg">
                ...
                <div class="mb-4">
                    <div class="flex items-baseline gap-2">
                        <span class="text-4xl font-black text-slate-900">₹0</span>
                        <span class="text-slate-600 text-xs">/mo</span>
                    </div>
                    <div class="flex items-center gap-2 mt-1">
                        <span class="text-slate-500 line-through text-sm">₹30,000</span>
                        <span class="bg-red-100 text-red-700 px-2 py-0.5 rounded-full text-[10px] font-bold">SAVE 100%</span>
                    </div>
                </div>
                ...
                <ul class="space-y-2 mb-6 text-sm text-slate-700">
                    <li class="flex items-center gap-2 font-medium">
                        <i class="fa-solid fa-check text-secondary text-xs"></i> Unlimited Listings
                    </li>
                    <li class="flex items-center gap-2 font-medium">
                        <i class="fa-solid fa-check text-secondary text-xs"></i> 10 Featured Slots
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-secondary text-xs"></i> 180-Day Validity
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-secondary text-xs"></i> Advanced Analytics
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-secondary text-xs"></i> CRM + AI Reports
                    </li>
                </ul>
                
                <a href="register.php?plan=gold" class="block w-full text-center bg-gradient-to-r from-secondary to-yellow-500 text-white py-3 rounded-lg font-bold hover:shadow-xl transition text-xs uppercase tracking-wide">
                    Start Free Now <i class="fa-solid fa-arrow-right ml-1"></i>
                </a>
            </div>

            <!-- Diamond Plan -->
            <div class="bg-white/95 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-xl font-bold text-slate-900">Diamond</h3>
                        <p class="text-xs text-slate-500">For Enterprises</p>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <span class="text-slate-400 line-through text-sm">₹35,000</span>
                        <span class="bg-red-100 text-red-700 px-2 py-0.5 rounded-full text-[10px] font-bold">SAVE 100%</span>
                    </div>
                </div>
                ...
                <ul class="space-y-2 mb-6 text-sm text-slate-700">
                    <li class="flex items-center gap-2 font-medium">
                        <i class="fa-solid fa-check text-cyan-500 text-xs"></i> Unlimited Listings
                    </li>
                    <li class="flex items-center gap-2 font-medium">
                        <i class="fa-solid fa-check text-cyan-500 text-xs"></i> Unlimited Featured
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-cyan-500 text-xs"></i> 365-Day Validity
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-cyan-500 text-xs"></i> Enterprise Analytics
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fa-solid fa-check text-cyan-500 text-xs"></i> Dedicated Manager
                    </li>
                </ul>
                
                <a href="register.php?plan=diamond" class="block w-full text-center bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-2.5 rounded-lg font-bold hover:shadow-xl transition text-xs uppercase tracking-wide">
                    Get Started Free
                </a>
            </div>
        </div>
