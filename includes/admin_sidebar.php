...
<aside class="w-64 bg-slate-900 text-white fixed top-0 bottom-0 left-0 overflow-y-auto z-30 hidden lg:block">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            <a href="<?php echo BASE_URL; ?>/admin/dashboard.php" class="flex items-center gap-3 px-4 py-3 rounded-xl <?php echo $current_page == 'dashboard.php' ? 'bg-secondary text-white shadow-lg shadow-secondary/50' : 'text-slate-300 hover:bg-slate-800 hover:text-white transition'; ?>">
                <i class="fa-solid fa-gauge-high w-5"></i> Dashboard
            </a>
            <a href="<?php echo BASE_URL; ?>/admin/users.php" class="flex items-center gap-3 px-4 py-3 rounded-xl <?php echo $current_page == 'users.php' ? 'bg-secondary text-white shadow-lg shadow-secondary/50' : 'text-slate-300 hover:bg-slate-800 hover:text-white transition'; ?>">
            ...
            <a href="<?php echo BASE_URL; ?>/admin/banners.php" class="flex items-center gap-3 px-4 py-3 rounded-xl <?php echo $current_page == 'banners.php' ? 'bg-secondary text-white shadow-lg shadow-secondary/50' : 'text-slate-300 hover:bg-slate-800 hover:text-white transition'; ?>">
